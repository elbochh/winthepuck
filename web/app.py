...
Three things worth knowing before reading further:
  * none of the hockey data is typed in by hand. The teams, the games, the
...
def monitoring_page():
    ...
    The walk-forward test scored the model once. This page keeps scoring it, because a model
...
@app.route("/api/model")
def api_model():
    """The model's real scorecard from the walk-forward test."""
    return jsonify({
