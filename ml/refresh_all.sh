...
(cd ../pipeline && python3 main.py --mode historical)

echo "=== 2/6 rebuild merged modeling table ==="
(cd ../pipeline && python3 main.py --mode build-merged)
...
(cd ../pipeline && python3 main.py --mode build-live-features --start-season 20222023 --end-season 20252026)
