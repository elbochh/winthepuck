...
nhl-prediction-website/data/. Every number on the site comes from here.
...
PIPE = HERE.parent / "nhl_data_pipeline" / "data" / "processed"
SITE = HERE.parent / "nhl-prediction-website" / "data"
