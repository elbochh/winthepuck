...
The walk-forward test in Phase 2 left behind one very useful file: the
...
DEFAULT_PREDICTIONS = HERE.parents[1] / "nhl_model" / "data" / "walkforward_predictions.csv"
...
def main() -> None:
    ...
    parser.add_argument("--predictions", type=Path, default=DEFAULT_PREDICTIONS,
                        help="the walk-forward predictions CSV from Phase 2")
