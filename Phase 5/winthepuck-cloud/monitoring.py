...
Phase 2 tested the model once and wrote down a score. That score starts going
...
The evaluation study in `model-service/evaluate_model.py` showed exactly that
...
def baseline_season() -> int:
    ...
    Games from this season were loaded from the Phase 2 walk-forward test.
